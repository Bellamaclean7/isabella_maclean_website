...
cat('<div style="display: flex; align-items: center;">
    <img src="photo.png" alt="Isabella MacLean" style="width: 50px; margin-right: 10px;"/>
    <h1>Isabella MacLean</h1>
</div>')
```
...
See my LinkedIn [here](https://www.linkedin.com/in/bella-maclean-33b4b417b/).